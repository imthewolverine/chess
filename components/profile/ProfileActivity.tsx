        ...
        <div className="container mx-auto grid grid-cols-12 gap-6">
            ...
            <div className='col-span-8'>
                ...
                <div className='p-[30px] pb-[15px] border border-[#D9D9D9] rounded-xl shadow-special'>
                    ...
                    <input value="" id="title" className="h-10 p-3 mt-3 w-full border border-slate-400 rounded-xl text-lg" type="text" />
                    <label htmlFor="title" className='text-lg'>Тайлбар</label>
                    <textarea value="" id="title" className="h-20 p-3 mt-3 w-full border border-slate-400 rounded-xl text-lg"/>
